      ...
      <Popover class="relative bg-white">
        ...
        >
          ...
          <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <NuxtLink
              to="/login"
              class="whitespace-nowrap text-base font-medium text-purple-500 hover:text-gray-900"
            >
              Log In
            </NuxtLink>
            <NuxtLink
          ...
          <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
            ...
            <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
              ...
              >
                ...
                <span class="block text-indigo-200">Medical Support</span>
              </h1>
              <p
            ...
            >
              <div>
                ...
                <div class="mt-6">
                  ...
                  >
                    Stay on top of your medical support
                  </h2>
      ...
      <div class="bg-gradient-to-r from-purple-800 to-indigo-700">
        ...
        >
          <h2 class="text-3xl font-extrabold text-white tracking-tight">
            Strong Patient-Doctor communication for maximum efficiency
          </h2>
        ...
        >
          ...
          >
            ...
            <p class="mt-3 text-3xl font-extrabold text-white">
              Get fast, efficient and specific replies
            </p>
      ...
      <div class="bg-white">
        ...
        >
          ...
          >
            ...
            <span
              class="-mb-1 pb-1 block bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent"
...
const solutions = [
  {
    name: 'Inbox',
    description: 'Fast, dynamic and practical doctor response service.',
    href: '#',
    icon: InboxIcon,
  },
  {
    name: 'Messaging',
    description: 'Speak directly to a doctor in a more meaningful way.',
    href: '#',
    icon: AnnotationIcon,
  },
  {
    name: 'Downloads',
    description: 'Download prescriptions at any time.',
    href: '#',
    icon: ChatAlt2Icon,
  },
  {
    name: 'Knowledge Base',
    description: 'Connect with the best doctors around the world.',
    href: '#',
